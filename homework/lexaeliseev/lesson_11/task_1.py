...
book_2 = Book('Мастер и Маргарита', 'Булгаков', 650)
book_3 = Book('Преступление и наказание', 'Достоевский', 450)
book_4 = Book('Евгений Онегин', 'Пушкин', 250)
book_5 = Book('Тихий Дон', 'Шолохов', 900)
...
book_10 = SchoolBook("Литература", "Смирнова", 400, "Гуманитарные науки", 7)
